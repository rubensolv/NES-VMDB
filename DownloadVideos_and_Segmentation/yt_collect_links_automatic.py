...
if __name__ == '__main__':
    ...
    parser.add_argument('--mids', type=str, default='/home/rubens/pythonProjects/NesToMidGeneration/data/nesmdb_midi/all/')
    args = parser.parse_args()
    
    #get the games titles based on the mids we have
    games_titles = get_game_titles(args.mids)
    with open('nesmdb_csv_youtube.csv', 'w', newline='') as csvfile:
